...
const Signup = () => {
  ...
  return (
    <div className='w-full min-h-screen flex items-center justify-center flex-col lg:flex-row bg-[#242323]'>
        ...
        <div className='w-full md:w-1/3 p-4 md:p-1 flex flex-col justify-center items-center '>
          ...
          >
            ...
            <Textbox
                ...
                error={errors.name ? errors.email.name : ""}
              />
              <Textbox
              ...
              <span className='text-sl text-gray-500 hover:text-blue-600 hover:underline cursor-pointer' onClick={handleButtonClick}>
                  Login 
                 </span>
                 </span>
            </div>
